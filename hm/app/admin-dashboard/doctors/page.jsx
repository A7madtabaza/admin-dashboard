...
//           <Link href="/admin-dashboard/doctors/new">
//             <button className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-lg shadow-md">
//               + إضافة طبيب
//             </button>
//           </Link>
//         </div>
...
//         ) : doctors.length === 0 ? (
//           <div className="bg-white rounded-lg shadow-md p-8 text-center">
//             <p className="text-gray-600 text-lg">لا يوجد أطباء حالياً</p>
//           </div>
//         ) : (
//           <div className="bg-white rounded-lg shadow-md overflow-hidden">
//             <div className="overflow-x-auto">
...
//                   <tr>
//                     <th className="px-6 py-3 text-right text-xs font-medium text-gray-800">
//                       #
//                     </th>
//                     <th className="px-6 py-3 text-right text-xs font-medium text-gray-800">
//                       الاسم
...
//                     <tr
//                       key={doctor._id}
//                       className={index % 2 === 0 ? "bg-pink-50" : ""}
//                     >
//                       <td className="px-6 py-4">{index + 1}</td>
...
//           إجمالي عدد الأطباء: {doctors.length}
//         </div>
//       </div>
//     </div>
//   );
